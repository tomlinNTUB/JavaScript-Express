...
### 測試方式
```
https://自己的app名稱.herokuapp.com/product/page/1
```
...
```
 <web>
   ...
   |      |__ fetchRangeOfProducts.ejs   (前一講)   
   ...
   |      |__ fetchRangeOfProducts.js  (前一講)   
...
var fetchPageOfProducts = async function(pageNo){
    ...
    await query('SELECT * FROM product LIMIT $2 OFFSET $1', [(pageNo-1)*linePerPage, linePerPage])
        .then((data) => {
