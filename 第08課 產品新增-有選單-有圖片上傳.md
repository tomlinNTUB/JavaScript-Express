...
router.post('/', upload.single('picture'), function(req, res) {
    ...
    if(req.file.size>maxSize){
        res.render('productFileSizeFail', {});  //新增失敗
        return;
    }		
    ...
    var picture=req.file.filename;   //取得上傳照片新名稱
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- ........................................... -->				
                <form role="form" method="post" enctype="multipart/form-data" action="/productAdd">
