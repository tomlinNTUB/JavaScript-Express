    ...
    pool.query('select count(*) as cnt from product', function(err, results) {
        ...
        pool.query('select * from product limit ?, ?',[(pageNo-1)*linePerPage, linePerPage], function(err, results) {
            ...
            if(results.length==0){
                ...
                res.render('productListByPage', {data:results, pageNo:pageNo, totalLine:totalLine, totalPage:totalPage, startPage:startPage});
            }
        });	
    });	
});
...
#####(5-4) 檔案名稱: productListByPage.ejs
```js
<!DOCTYPE html>
            ...
            <div class="col-md-10">
                <ul class="pagination">
                    ...
                    <% if(startPage+10<totalPage){ %>
                        <li>
                            <a href="/productListByPage?pageNo=<%=(startPage+10)%>">...下一區段</a>
                        </li>
                    <% } %>							
                </ul>
            </div>	
